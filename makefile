...
SFILES = main.asm
IFILES = fnc_init.inc fnc_sound.inc fnc_sprites.inc fnc_demo.inc data_demo.inc fnc_game.inc fnc_loop.inc data_game.inc data_jmimu.inc fnc_text.inc level10.inc level1.inc fnc_ingame.inc
OFILES = main.o
